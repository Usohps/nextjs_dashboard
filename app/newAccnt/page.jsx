...
function NewAccntPage() {
  ...
  // const handleSubmit = () => {
  //   if (isChecked1) {
  //     router.push('/Individual_accnt');
  //   } else if (isChecked2) {
  //     router.push('/coperate_accnt');
  //   }
  // };
  return (
    <div className="w-full min-h-screen flex items-center justify-center border  border-red-700">
      <div className="border w-full lg:w-1/2 space-y-5  p-4 border-green-600">
        <div className="border-b-2 p-2 text-lg font-semibold text-center">
          <h2>New account</h2>
        </div>
        <div className="border flex flex-col md:flex-row items-center justify-between p-2 gap-4">
        ...
        {isChecked1 && (
          <div className="text-center flex-col items-center flex">
            ...
            <input type="text" className="block border md:w-[300px] w-full" />
          </div>
        )}
        {isChecked2 && (
          <div className="text-center flex-col items-center flex w-full">
            <h1>
        ...
        <div className="flex items-center flex-col">
          <button className="p-1 rounded font-bold text-white bg-yellow-500 border w-[170px]">
            Submit
          </button>
        </div>
      </div>
